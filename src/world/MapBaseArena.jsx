  ...
  return (
    <group>
      <mesh receiveShadow position={[0, -2.05, 0]}>
        ...
        <meshStandardMaterial color="#233722" roughness={0.99} metalness={0.01} />
      </mesh>

      <mesh receiveShadow rotation={[-Math.PI / 2, 0, 0]} position={[0, -1.08, 0]}>
        <circleGeometry args={[ARENA_RADIUS + 42.0, edgeSegments]} />
        <meshStandardMaterial color="#465f37" roughness={1} metalness={0} />
      </mesh>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, getTerrainHeight(0, 0) + 0.07, 0]}>
        ...
        <meshBasicMaterial color="#c79b45" transparent opacity={0.08} depthWrite={false} toneMapped={false} />
      </mesh>
      <mesh rotation={[-Math.PI / 2, 0, Math.PI / 10]} position={[0, getTerrainHeight(0, 0) + 0.09, 0]}>
        ...
        <meshBasicMaterial color="#83a35c" transparent opacity={0.055} depthWrite={false} toneMapped={false} />
      </mesh>
    </group>
  );
}
