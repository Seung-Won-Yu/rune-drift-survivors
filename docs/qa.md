...
The suite currently contains 84 cases. In addition to gameplay coverage, it checks transparent surroundings and retained artwork in all 80 player/enemy atlas cells, opening upgrade comparisons, armory build continuity, detour collection/expiry, and compact navigation/low-health layouts. Character captures cover low/balanced/high at 360×740 plus balanced at 320×568, 568×320, and 740×360.
