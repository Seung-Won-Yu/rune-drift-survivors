...
최종 로컬 코어 70개·브라우저 50개와 Pages 하위 경로 production 검사가 통과했다. 1280×720, 390×844, 740×360에서 적 160마리의 12초 부하 검사 p95는 모두 약 16.7ms, 50ms 초과 프레임은 0개였다. 개발용 QA 전역은 배포 빌드에서 제거되며 이미지 5개 로딩과 출발·일시정지도 통과했다. 인앱 브라우저에서 출발 HUD의 국면 이름과 실제 정지 화면을 확인했다.
