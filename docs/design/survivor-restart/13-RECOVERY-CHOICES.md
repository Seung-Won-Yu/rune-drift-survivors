...
동일 시드·이동·전투 규칙에서 체력 40% 이하일 때 실제 제시된 ‘숲의 심장’, 없으면 ‘생명의 숨결’을 우선 선택하도록 진단 도구를 고쳤다. 없는 카드를 생성하거나 선택 외의 체력·능력치·시간을 직접 수정하지 않는다. [선택 전후 기록](./recovery-choice-diagnostic-2026-09-10.json).
